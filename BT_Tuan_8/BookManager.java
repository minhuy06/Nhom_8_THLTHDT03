...
public class BookManager implements IQuanLySach{
	...
	public void Add() {
		...
		if(choice == 1) {
			...
			Book TB = new Textbook(ID, Title, Author, Year, Quantity, Gia, MonHoc, CapDo);
			Manage.add(TB);
		}
		if(choice == 2) {
			...
			sc.nextLine();
			Book NV = new Novel(ID, Title, Author, Year, Quantity, Gia, TheLoai, LaSachSeries);
			Manage.add(NV);
		}
	}
	...
	public void Start() {
		int choice = 1;
		while(choice != 0) {
			System.out.println("1. Them Sach   2. Hien thi   3. Xoa   4. Cap nhat   5. Tim   0. Thoat");
